...
trait Cli extends ScalaModule with ScalaJsCliPublishModule {
  ...
  def ivyDeps = super.ivyDeps() ++ Seq(
    ...
    ivy"com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-core:2.28.2", // This is the java8 version of jsoniter, according to scala-cli build
    ivy"com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-macros:2.28.2", // This is the java8 version of jsoniter, according to scala-cli build
